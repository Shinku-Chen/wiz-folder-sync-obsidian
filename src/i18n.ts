...
const translations = {
	en: {
		...
		statusIdle: 'WizNote sync idle',
		statusStopped: 'WizNote sync stopped',
		statusTestingConnection: 'Testing WizNote connection...',
		statusConnectionOk: 'WizNote connection ok',
		statusConnectionFailed: 'WizNote connection failed',
		statusSyncingFolder: 'Syncing folder to WizNote...',
		statusSyncFailed: 'Sync failed',
		statusDeletingRemote: 'Moving WizNote note to trash...',
		statusDeletingRemoteFolder: 'Moving WizNote folder notes to trash...',
		statusAutoSyncing: 'Auto syncing: {{path}}',
		noticeSyncRunning: 'Sync is already running.',
		noticeConnectionFailed: 'WizNote connection failed: {{message}}',
		noticeSyncFailed: 'Sync failed: {{message}}',
		noticeRemoteDeleteFailed:
			'Failed to move WizNote note to trash: {{message}}',
		noticeRemoteFolderDeleteFailed:
			'Failed to move WizNote folder notes to trash: {{message}}',
		noticeConnectionOk:
		...
		settingWizAccountName: 'WizNote account',
		...
		settingTargetCategoryDesc:
			'WizNote category path. Leave empty to sync every category except /Deleted Items/.',
		settingSyncModeName: 'Sync mode',
		settingSyncModeDesc:
			'Choose bidirectional sync, Obsidian to WizNote only, or WizNote to Obsidian only.',
		settingSyncModeBidirectional: 'Bidirectional',
		settingSyncModeLocalToRemote: 'Obsidian to WizNote only',
		settingSyncModeRemoteToLocal: 'WizNote to Obsidian only',
		...
		placeholderSourceFolder: 'Inbox/to WizNote',
		placeholderTargetCategory: '/my notes/Obsidian Sync/',
		errorWizAccountRequired: 'WizNote account is required.',
		errorWizPasswordRequired: 'WizNote password is required.',
		...
		errorCollaborationUserGuidMissing:
			'Collaboration sync needs userGuid from the WizNote login result.',
	...
	zh: {
		...
		statusIdle: '为知笔记同步空闲中',
		statusStopped: '为知笔记同步已停止',
		statusTestingConnection: '正在测试为知笔记连接...',
		statusConnectionOk: '为知笔记连接正常',
		statusConnectionFailed: '为知笔记连接失败',
		statusSyncingFolder: '正在同步目录到为知笔记...',
		...
		placeholderSourceFolder: '收件箱/同步到为知笔记',
		placeholderTargetCategory: '/My Notes/Obsidian Sync/',
